...
class MinimumSpanningTreeExample {
    ...
    // create showMinimumSpanningTree for printing the constructed MST stored in
    // mstArray[]
    ...
    // create designMST() method for constructing and printing the MST. The
    // graphArray[][] is an adjacency matrix that defines the graph for MST.
    void designMST(int graphArray[][]) {
        // create array of size total number of vertices, i.e., countOfVertices for
        // storing the MST
        ...
        // create setOfMST array of type boolean for representing the set of vertices
        // included in MST
        ...
        for (int i = 0; i < countOfVertices - 1; i++) {
            ...
            // change the key value and the parent index of all the adjacent vertices of the
            // selected vertex. The vertices that are not yet included in Minimum Spanning
            // Tree are only considered.
            for (int vertex = 0; vertex < countOfVertices; vertex++)

                // The value of the graphArray[edge][vertex] is non zero only for adjacent
                // vertices of m setOfMST[vertex] is false for vertices not yet included in
                // Minimum Spanning Tree
                // when the value of the graphArray[edge][vertex] is smaller than key[vertex],
                // we update the key
